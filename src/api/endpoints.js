...
api.interceptors.request.use((config) => {
  ...
  if (token && token !== "undefined") {
    const authHeader = token.startsWith("eyJ")
      ? `Bearer ${token}`
      : `Token ${token}`;
...
export const authAPI = {
  login: async (username, password) => {
    ...
    if (data.access && data.refresh) {
      ...
      throw new Error(
        "Unexpected login response format: " + JSON.stringify(data),
      );
    }
...
export const contentAPI = {
  ...
  publicList: (params = {}) =>
    cachedGet("/api/content/public/", { params }, CACHE_TTL.data),
...
export const galleriesAPI = {
  list: (params = {}) =>
    cachedGet("/api/galleries/", { params }, CACHE_TTL.data),
  get: (id) => cachedGet(`/api/galleries/${id}/`, {}, CACHE_TTL.data),
  create: (formData) => {
    invalidatePrefix("/api/galleries");
    return api.post("/api/galleries/", formData, {
      headers: { "Content-Type": "multipart/form-data" },
    });
  },
  update: (id, formData) => {
    invalidatePrefix("/api/galleries");
    return api.put(`/api/galleries/${id}/`, formData, {
      headers: { "Content-Type": "multipart/form-data" },
    });
  },
  delete: (id) => {
...
export const profileAPI = {
  ...
  update: (data) => {
    invalidatePrefix("/api/users/profile");
...
export const studentsAPI = {
  list: (params = {}) =>
    cachedGet("/api/students/", { params }, CACHE_TTL.data),
  ...
  exportCSV: (params = {}) =>
    api.get("/api/students/export-csv/", { params, responseType: "blob" }),
  exportForCBT: (params = {}) =>
  ...
  getPromotionAnalysis: (params) =>
    cachedGet("/api/users/promotion/", { params }, CACHE_TTL.data),
  getPromotionRules: (params) =>
    cachedGet("/api/users/promotion/rules/", { params }, CACHE_TTL.academic),
  savePromotionRules: (data) => {
    invalidatePrefix("/api/users/promotion");
    return api.post("/api/users/promotion/rules/save/", data);
  },
  getPromotionSubjects: () =>
    cachedGet("/api/users/promotion/subjects/", {}, CACHE_TTL.static),
};
...
export const academicSessionsAPI = {
  list: (params = {}) =>
    cachedGet("/api/academic-sessions/", { params }, CACHE_TTL.academic),
  get: (id) =>
    cachedGet(`/api/academic-sessions/${id}/`, {}, CACHE_TTL.academic),
  create: (data) => {
    invalidatePrefix("/api/academic-sessions");
    return api.post("/api/academic-sessions/", data);
  },
  update: (id, data) => {
    invalidatePrefix("/api/academic-sessions");
    return api.put(`/api/academic-sessions/${id}/`, data);
  },
  delete: (id) => {
    invalidatePrefix("/api/academic-sessions");
    return api.delete(`/api/academic-sessions/${id}/`);
  },
  setActive: (id) => {
    invalidatePrefix("/api/academic-sessions");
    return api.post(`/api/academic-sessions/${id}/set-active/`);
  },
};
...
export const termsAPI = {
  list: (params = {}) =>
    cachedGet("/api/terms/", { params }, CACHE_TTL.academic),
  get: (id) => cachedGet(`/api/terms/${id}/`, {}, CACHE_TTL.academic),
  create: (data) => {
    invalidatePrefix("/api/terms");
    return api.post("/api/terms/", data);
  },
  update: (id, data) => {
    invalidatePrefix("/api/terms");
    return api.put(`/api/terms/${id}/`, data);
  },
  delete: (id) => {
    invalidatePrefix("/api/terms");
    return api.delete(`/api/terms/${id}/`);
  },
  setActive: (id) => {
    invalidatePrefix("/api/terms");
    return api.post(`/api/terms/${id}/set-active/`);
  },
};
...
export const classLevelsAPI = {
  list: (params = {}) =>
    cachedGet("/api/class-levels/", { params }, CACHE_TTL.static),
  get: (id) => cachedGet(`/api/class-levels/${id}/`, {}, CACHE_TTL.static),
  create: (data) => {
    invalidatePrefix("/api/class-levels");
    return api.post("/api/class-levels/", data);
  },
  update: (id, data) => {
    invalidatePrefix("/api/class-levels");
    return api.put(`/api/class-levels/${id}/`, data);
  },
  delete: (id) => {
    invalidatePrefix("/api/class-levels");
    return api.delete(`/api/class-levels/${id}/`);
  },
};
...
export const subjectsAPI = {
  list: (params = {}) =>
    cachedGet("/api/subjects/", { params }, CACHE_TTL.static),
...
export const caScoresAPI = {
  list: (params = {}) =>
    cachedGet("/api/ca-scores/", { params }, CACHE_TTL.data),
  get: (id) => cachedGet(`/api/ca-scores/${id}/`, {}, CACHE_TTL.data),
  create: (data) => {
    invalidatePrefix("/api/ca-scores");
    return api.post("/api/ca-scores/", data);
  },
  update: (id, data) => {
    invalidatePrefix("/api/ca-scores");
    return api.put(`/api/ca-scores/${id}/`, data);
  },
  delete: (id) => {
    invalidatePrefix("/api/ca-scores");
    return api.delete(`/api/ca-scores/${id}/`);
  },
  bulkUpload: (formData) => {
    invalidatePrefix("/api/ca-scores");
  ...
  exportTemplate: () =>
    api.get("/api/ca-scores/export-template/", { responseType: "blob" }),
  getByStudent: (studentId, params = {}) =>
    cachedGet(
      `/api/ca-scores/student/${studentId}/`,
      { params },
      CACHE_TTL.data,
    ),
};
...
export const examResultsAPI = {
  list: (params = {}) =>
    cachedGet("/api/exam-results/", { params }, CACHE_TTL.data),
  get: (id) => cachedGet(`/api/exam-results/${id}/`, {}, CACHE_TTL.data),
  create: (data) => {
    invalidatePrefix("/api/exam-results");
    return api.post("/api/exam-results/", data);
  },
  update: (id, data) => {
    invalidatePrefix("/api/exam-results");
    return api.put(`/api/exam-results/${id}/`, data);
  },
  partialUpdate: (id, data) => {
    invalidatePrefix("/api/exam-results");
    return api.patch(`/api/exam-results/${id}/`, data);
  },
  delete: (id) => {
    invalidatePrefix("/api/exam-results");
    return api.delete(`/api/exam-results/${id}/`);
  },
  ...
  recalculatePositions: (data) => {
    invalidatePrefix("/api/exam-results");
    return api.post("/api/exam-results/recalculate-positions/", data);
  },
  syncCAScores: (data) => {
    invalidatePrefix("/api/exam-results");
    return api.post("/api/exam-results/sync-ca-scores/", data);
  },

  exportObjTemplate: () =>
    api.get("/api/exam-results/export-template-obj/", { responseType: "blob" }),
  exportTheoryTemplate: () =>
    api.get("/api/exam-results/export-template-theory/", {
      responseType: "blob",
    }),

  getByStudent: (studentId, params = {}) =>
    cachedGet(
      `/api/exam-results/student/${studentId}/`,
      { params },
      CACHE_TTL.data,
    ),
};
...
export const feesAPI = {
  overview: (params = {}) =>
    cachedGet("/api/users/fees/overview/", { params }, CACHE_TTL.stats),
  downloadTemplate: (params = {}) =>
    api.get("/api/users/fees/template/", { params, responseType: "blob" }),
  bulkUpload: (formData, config = {}) => {
    invalidatePrefix("/api/students");
  ...
  bulkSet: (studentIds, paid) => {
    invalidatePrefix("/api/students");
    invalidatePrefix("/api/users/fees");
    return api.post("/api/users/fees/bulk-set/", {
...
export const eventsAPI = {
  list: (params = {}) => cachedGet("/api/events/", { params }, CACHE_TTL.data),
  get: (id) => cachedGet(`/api/events/${id}/`, {}, CACHE_TTL.data),
  create: (formData) => {
  ...
  partialUpdate: (id, formData) => {
    invalidatePrefix("/api/events");
    const isFormData = formData instanceof FormData;
    return api.patch(`/api/events/${id}/`, formData, {
      headers: isFormData
        ? { "Content-Type": "multipart/form-data" }
        : { "Content-Type": "application/json" },
    });
  ...
  upcoming: () => cachedGet("/api/events/upcoming/", {}, CACHE_TTL.data),
};
...
export const behavioralAPI = {
  list: (params = {}) =>
    cachedGet("/api/users/behavioral-assessments/", { params }, CACHE_TTL.data),
  get: (id) =>
    cachedGet(`/api/users/behavioral-assessments/${id}/`, {}, CACHE_TTL.data),
  create: (data) => {
    invalidatePrefix("/api/users/behavioral");
    return api.post("/api/users/behavioral-assessments/", data);
  },
  update: (id, data) => {
    invalidatePrefix("/api/users/behavioral");
    return api.put(`/api/users/behavioral-assessments/${id}/`, data);
  },
  partialUpdate: (id, data) => {
    invalidatePrefix("/api/users/behavioral");
    return api.patch(`/api/users/behavioral-assessments/${id}/`, data);
  },
  delete: (id) => {
    invalidatePrefix("/api/users/behavioral");
    return api.delete(`/api/users/behavioral-assessments/${id}/`);
  },
  downloadTemplate: (params = {}) =>
    api.get("/api/users/behavioral/template/", {
      params,
      responseType: "blob",
    }),
  bulkUpload: (formData, config = {}) => {
...
export const uploadExamResults = (formData) =>
  examResultsAPI.bulkUpload(formData);
