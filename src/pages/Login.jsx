...
const handleAdminLogin = async (e) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-blue-100 to-indigo-200 flex items-center justify-center p-2 sm:p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm sm:max-w-md p-4 sm:p-6 md:p-8 border border-gray-200">
        <div className="text-center mb-6 sm:mb-8">
          <img src="/logo.webp" alt="Logo" className="h-12 sm:h-16 w-auto mx-auto mb-3 sm:mb-4" />
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 font-sans mb-1 sm:mb-2">
            MOLEK SCHOOLS
          </h1>
          <p className="text-sm sm:text-base text-gray-600">Admin Portal</p>
        </div>
